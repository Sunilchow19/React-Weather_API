  ...
  function sty() {
    if (obj.main.temp < 273.15) {
      return (
        <>
          <img
            src="https://i.pinimg.com/originals/61/2a/67/612a677c31da6f703d79ed41a0f3dd7e.jpg"
            alt=""
            width={400}
          />
          <h1>{obj.name}</h1>
      ...
      return (
        <>
          <img
            src="https://th.bing.com/th/id/OIP.QcFHZet_hrkpxNdVMjSZigHaE7?rs=1&pid=ImgDetMain"
            alt=""
            width={400}
          />
          <h1>{obj.name}</h1>
      ...
      return (
        <>
          <img
            src="https://1471793142.rsc.cdn77.org/data/images/full/6325/weather.jpg"
            alt=""
            width={400}
          />
          <h1>{obj.name}</h1>
      ...
      return (
        <>
          <img
            src="https://wallpapercave.com/wp/wp4555644.jpg"
            alt=""
            width={400}
          />
          <h1>{obj.name}</h1>
